...
mkdir RUN_DIR\ interest_points
%% Get list of file name of input images
img_file_names = genFileNames({Global.Image_Dir_Name}, ...
    1:Categories.Total_Frames,"RUN_DIR\resized_images", ...
    Global.Image_File_Name,Global.Image_Extension,Global.Num_Zeros);

for i=1:Categories.Total_Frames
    img_file_names{i}(3:4) = [];
    img_file_names{i}(6) = img_file_names{i}(5);
    img_file_names{i}(5) = '_resized';
end 
