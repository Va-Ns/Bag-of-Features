...
%     1:Categories.Total_Frames,"C:\Users\vasil\MATLAB Drive\Thesis\" + ...
%     "Matlab Projects\bag_words_demo\common\RUN_DIR", ...
...
tic;
for i = 1:length(img_file_names)
    im =im2gray(imread(strjoin(img_file_names{i},'')));
    [features{i},validPoints{i}] = extractFeatures(im, ...
        interest_points{i},"Method","SIFT");
